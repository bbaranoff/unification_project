...
EVENTS=(
  ...
  "GW170104 880 20 350 1.5 1200"
  "GW170814 540 20 350 1.5 1200"
  "GW170817 40  30 1200 1.5 1200"
)
...
for e in "${EVENTS[@]}"; do
  ...
  echo "============================================================="
  echo "📡 Téléchargement des données pour ${event}..."
  echo "📡 Téléchargement des données pour ${event}..."
  
  python3 ligo_spectral_planck.py \
    --event "${event}" \
    --distance-mpc "${dist}" \
    --flow "${flow}" \
    --fhigh "${fhigh}" \
